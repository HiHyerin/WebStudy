...
<body>
	...
	<div class="wrapper row3">
		<main class="container clear">
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=474ea1f30b292f1e0644ae92fbff277&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
...
<div style="height: 20px"></div>
    ...
    <div class="content three_quarter first">
	           ...
	           <tr>
	             <td colspan="2"><pre style="white-space:pre-wrap;background-color: white;border:none ">${rvo.msg }</pre></td>
	           		...
	           		<tr id="u${rvo.rno }" class="rupdate" style = "display:none">
						  	<td colspan="2">
						  		<form method = "post" action="../all_reply/all_reply_update.do"> <!--  모델로 고고 -->
     ...
     <table class="table">
      <c:if test="${sessionScope.id != null }">
	   <!-- 댓글 쓰는 위치(로그인이 되어야만 쓸 수 있게 할 것임) -->
	    <table class="table">
	     <tr>
	       <td>
