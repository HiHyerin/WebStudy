...
<body>
	<div class="container">
		<div class="row">
		<form method="post" action="insert_ok(입력폼 처리).jsp">
		<table class="table">
			...
			<tr>
				...
				<td width=80%>
				<textarea row="10" cols="50" name=content></textarea>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" class="text-center">
					...
					<input type=button class="btn btn-sm btn-warining" onclick="javascript:history.back()" value="취소">
				</td>
			</tr>
		</table>
		</form>
