...
<!-- 
서비스
오늘의선곡 TV속음악 시대별음악 레이블추천 스타플레이리스트 브랜드DJ
...
1. selector : p.127
2. event : click , change(달력) , hover(마우스 갖다댔을 때) , keyup , keydown(enter) ..
3. jquery에서 지원하는 함수
	input => val()
	태그값 : html() , text()
	속성값 : attr()
	태그를 여러개 추가 : append()
	클래스 추가 (class="___") : addClass , removeClass
	태그 삭제 : remove
...
$(function(){
	...
	let arr2 = ["기분전환", "외로움", "슬픔", "힘찬", "이별",  "설렘", "위로", "사랑", "스트레스", "그리움", "추억", "우울", 
				"행복", "불안", "분노", "기쁨", "축하"];
