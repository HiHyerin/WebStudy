...
<script type="text/javascript">
	// 로그인, 회원가입, 회원수정, 아이디찾기, 탈퇴, 예약, 추천, 검색, 장바구니, 결제 => ajax (jquery를 알아야 사용할 수 있다)
	// 전역변수
	...
	function movie(no){
		for(let m of music){
			if(m.no===no){
				$('#title').text(m.title)
				$('#movie').attr("src","http://youtube.com/embed/"+m.key)
				break;
			}
	...
	<div class="container">
	  <div class="row">
	    ...
	    <div class="row">
	      ...
	      <div class="col-sm-3">
	      	<h3 id="title">MV</h3>
	      	<embed src="" width=500 height="450" id="movie"></embed>
	      </div>
